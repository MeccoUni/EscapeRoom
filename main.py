...
# 1-Intro
# 2-Examine room
#    Wall Writing - Give riddle
#    Flower in pot - neutral dialog
# 3-Answering riddle
#     Correct - next room open move into next room
#     Wrong - Death dialog
                    ...
                    while do != "ROLL":
                        ...
                        if do == "BARREL":
                            ...
                            if do == "ROLL":
                                ...
                                #  Wall Writing - Give riddle
                                # 2-Answering riddle
                                #     Correct - give new riddle - next room open move into next room
                                #     Wrong - Death dialog
                                print(
                                        ...
                                        if do == "BUTTONS":
                                            ...
                                            while do != "BLUE TRIANGLE":
                                                ...
                                                if do == "BLUE TRIANGLE":
                                                    ...
                                                    #   Switch
                                                    #   Flip switch - ending
                                                    #   Don't flip switch - secret ending
                                                    print(
